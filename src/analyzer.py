...
## SNS 홍보 문구
"쌀먹" (ssalmug.com)을 홍보하는 X(트위터) 또는 스레드용 게시물을 1개 작성해주세요.

쌀먹의 특징 (아래 중 1-2개를 랜덤하게 선택하여 반영):
- 레퍼럴 링크 공유 문구를 복사하면 AI가 알아서 분류해줌
- 내 링크를 누군가 클릭하면 쉽게 답방 가능
- 링크를 공정하게 노출해서 오래된 공유도 소외되지 않음

작성 가이드:
- 현재 인기 이벤트/트렌드를 자연스럽게 언급
- 이모지 적절히 사용
- 해시태그 2-3개 포함
- 150자 이내로 간결하게
- 매번 다른 스타일로 작성 (질문형, 정보 공유형, 꿀팁형 등 다양하게)
